...
<head>
    ...
    <link type="text/css" rel="stylesheet" media="all" href="/augmentedmaps/sites/all/themes/wg/css/jquery-ui-1.8.10.custom.css" />
    <?php print $head ?>
    <?php print $styles ?>
    <?php print $scripts ?>
    <?php flush(); ?>
    <script type="text/javascript" src="/augmentedmaps/sites/all/themes/wg/scripts/jquery-1.4.4.min.js"></script>
    <script type="text/javascript" src="/augmentedmaps/sites/all/themes/wg/scripts/jquery.blockUI.js"></script>
    <script type="text/javascript" src="/augmentedmaps/sites/all/themes/wg/scripts/jquery-ui-1.8.10.custom.min.js"></script>
    <script type="text/javascript" src="/augmentedmaps/sites/all/themes/wg/scripts/augmentedmaps.js"></script>
...
<div id="layers_drawer" class="drawer"> 
	...
	<h3 class="accordion_title"><a href="#" >Layers</a></h3>
	...
	<h3 class="accordion_title"><a id="layers_order" href="#">Layer Ordering</a></h3>
...
<div id="search_drawer" class="drawer"> 
    ...
    <div id="search_accordion">
            <h3 class="accordion_title"><a href="#">Search</a></h3>
            <div>
                <div id="search_form" style="padding:0px;">
                    <form action="<?php print check_url(drupal_get_path('module', 'map'))?>/search.php" name="search" method="post">
...
<div id="tools_drawer" class="drawer"> 
    ...
    <div id="tools_accordion">
            <h3 class="accordion_title"><a id="lnkmeasurement" href="#">Measure</a></h3>
            <div id="measurement"></div>
            <h3 class="accordion_title"><a id="a-link-to-map" href="#">Link</a></h3>
            <div>
...
<div id="legend_drawer" class="drawer">
    ...
    <div id="legend_accordion">
        <h3 class="accordion_title"><a href="#">Legend</a></h3>

...
<head>
    ...
    <link type="text/css" rel="stylesheet" media="all" href="/augmentedmaps/sites/all/themes/augmentedmaps/css/jquery-ui-1.8.10.custom.css" />
    <?php print $head ?>
    <?php print $styles ?>
    <?php print $scripts ?>
    <?php flush(); ?>
    <script type="text/javascript" src="/augmentedmaps/sites/all/themes/augmentedmaps/scripts/jquery-1.4.4.min.js"></script>
    <script type="text/javascript" src="/augmentedmaps/sites/all/themes/augmentedmaps/scripts/jquery.blockUI.js"></script>
    <script type="text/javascript" src="/augmentedmaps/sites/all/themes/augmentedmaps/scripts/jquery-ui-1.8.10.custom.min.js"></script>
    <script type="text/javascript" src="/augmentedmaps/sites/all/themes/augmentedmaps/scripts/augmentedmaps.js"></script>
...
<!-- Logo -->
  <div id="logo">
    <a href="<?php print check_url($front_page)?>">
      <img src="<?php print check_url($front_page)?><?php print check_url(path_to_theme())?>/images/map-logo.gif" alt="augmented maps" id="am_logo"/>
    </a>
  </div>
<!-- Logo ends -->
...
<div id="search_drawer" class="drawer"> 
    ...
    <div id="search_accordion">
            ...
            <div>
                <div id="search_form" style="padding:3px;">
                    <form action="<?php print check_url(path_to_theme())?>/search.php" name="search" method="post">
                        <input type="text" size=15 name="search_string" id="search_string" />
...
<!-- map -->
<div id="map" style="position: absolute; top:80px; right:0px; height:100%; width:100%;">
</div>
<!-- map ends -->

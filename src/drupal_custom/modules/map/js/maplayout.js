...
var calculate = function () {
	...
	jQuery("#mapArea").height(winHeight - 130);
...
function linkIcons() {
  ...
  jQuery("#login").click(function(){
    jQuery("#userLogin").toggle(function(){

    if (jQuery("#userLogin").is(":visible")){
        jQuery("#login_btn").css("border", "4px solid #e5e5e5");
        jQuery("#login_btn").css("background-color", "#e5e5e5");
    }else{
        jQuery("#login_btn").css("border", "2px solid transparent");
        jQuery("#login_btn").css("background-color", "transparent");
    }
    });
  });
